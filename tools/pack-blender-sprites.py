...
manifest={'version':1,'generator':'Blender 5.2 / tools/build-blender-roster.py','frameSize':128,'directions':8,'poses':4,'actors':{}}
...
print(f'Packed {len(roster)} actors / {len(roster)*32} frames')
